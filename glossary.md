...
**Document Type (DOCTYPE)** - Declaration informing the browser what syntax (set of rules) your HTML document is written in, so the browser can correctly parse the HTML code.
...
**(HTML) Element** - Individual component of an HTML document, once the HTML document has been parsed into the Document Object Model in a browser.
...
**Metadata** - Data that describes other data. (ie: the _size_ of an _image_)
...
**Protocol** - Rules for how various network processes on the Internet should behave.
...
**Root Directory** - The top-level directory for your project. (ie: If all your code for a project is within a folder named _MyFavoriteApp_, _MyFavoriteApp_ would be your project's root directory.)
...
**SEO (Search Engine Optimization)** - Marketing process to increase the visibility of a website in a search engine's search results.
